...
- **가전 기능** :
<br>**MomentBox**는 사용자의 스마트홈 활동 데이터(LG 가전 데이터)를 기반으로                                
AI가 대화를 유도하고, 감정과 사진을 엮어 자연스럽게 일기를 생성해주는                                  
풀스택 애플리케이션입니다.

- **웹 디자인 출처**  :    
**[조구만](https://www.joguman.com/)**
   
- **팀명**  :    
**공감저장소** 

- **팀원 소개(중앙대학교 전자전기공학부 4명 / 기계공학부 1명)** : 
...
<img width="250" height="0" alt="Image" src="https://github.com/user-attachments/assets/cb5cee00-db54-42df-a2ae-45b00da2d1d1" />
