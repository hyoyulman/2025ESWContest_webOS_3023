...
class Config:
    # --- 기본 설정 ---
    SECRET_KEY = 'your-very-secret-key-that-you-should-change'
    
    # --- 데이터베이스 설정 ---
    MONGO_URI = "mongodb+srv://momentbox:123456789a@cluster42789.lgglmuj.mongodb.net/momentbox?retryWrites=true&w=majority&appName=Cluster42789&serverSelectionTimeoutMS=5000"
    MONGO_TZ_AWARE = True # 시간대 정보(timezone)를 인식하도록 설정
    
    # --- JWT 설정 ---
    JWT_SECRET_KEY = "super-secret-key-change-it"
    ...
    # --- Google API 설정 ---
    SERVICE_ACCOUNT_FILE = os.path.abspath(r"/home/pi/LG_Embeded/Cloud.json") # GCS 서비스 계정 키 경로
    GEMINI_API_KEY = os.getenv("GEMINI_API_KEY") # .env 파일에서 키를 읽어옵니다.
    GEMINI_MODEL = "models/gemini-2.5-flash"

    # --- GCS 설정 ---
    GCS_BUCKET_NAME = "momentbox" # 실제 GCS 버킷 이름으로 변경 필요

    # --- 서비스 URL 설정 ---
    # TODO: 이 URL은 내부 함수 호출로 변경하는 것이 좋습니다.
    SYSTEM_PROMPT = """
        너는 ‘일기 코치’다.
